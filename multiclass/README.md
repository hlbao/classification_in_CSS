...
5. Based on the cleaned social media comment data set, I also perform a dictionary-based method for sentiment analysis (positive, negative, or neutral). The basic idea behind lexicon-based model can be viewd here: https://methods.sagepub.com/dataset/howtoguide/dictionary-based-sentiment-analysis-in-econnews-2016-python
